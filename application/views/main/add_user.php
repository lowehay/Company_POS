			...
			<div class="card shadow">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<select name="role" id="branch-select" data-live-search="true" data-style="btn-sm btn-outline-secondary" class="form-control <?php echo form_error('role') ? 'is-invalid' : ''; ?>">
