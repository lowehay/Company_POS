			...
			<div class="card-body">
				...
				<div class="section">
					...
					<div class="form-group col-md-3 d-inline-block">
						...
						<select class="form-control selectpicker" data-live-search="true" data-style="btn-outline-secondary" name="product_category" required>
					...
					<div class="form-group col-md-3 d-inline-block">
						...
						<select class="form-control selectpicker" data-live-search="true" data-style="btn-outline-secondary" name="product_vat" required>
