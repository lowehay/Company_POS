...
<div class="card card-outline card-success" style="max-width:100%; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
  <div class="card-header  ">   
    <a href="<?php echo site_url('visitor_portal/add_supplier'); ?>" class="btn btn-primary btn-sm "><i class="fas fa-plus"></i> Add Supplier </a>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      <table class="table  table-stripped table-sm" id="user-datatables">
        <thead>
         ...
         foreach($supplier as $supp) : ?>
          ...
          <tr class="text-center">
            ...
            <td>
              ...
              <a href="<?php echo site_url('main/edit_supplier/'. $supp->supplier_id); ?>" style="color:gold; padding-left:6px;"  title="Click here to edit supplier details"> <i class="fas fa-edit"></i></a>
...
<script>
  $(document).ready(function(){
    ...
    $(this).parents(".text-center").animate({ backgroundColor: "#fbc7ca7" }, "fast")
